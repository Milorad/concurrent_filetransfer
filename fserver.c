...
//#include <semaphore.h>		// NULL definition
#include "include/genlib.h"
#include "include/tcp-server.h"
//#include "include/shmsem.h"
...
void iterme(){
	//int y;
	//for (y=0; y < 10; y++){
		//printf("SS: %s\n", storeme[y].addr->filename);
	//}
	//printf("iterme-sizeof(%p)\n", storage.addr[1]);
	//printf("iterme-sizeof(%p)\n", storage.addr[2]);
}
